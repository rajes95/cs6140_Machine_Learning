...
Problem 2.1b - Classification Trees With Categorical Features - Binary Mushroom Dataset
...
#     pd.set_option('display.max_rows', None)
    ...
    # you want.
    mushData = mushData.sample(150).reset_index(drop=True)

    print("Mushroom Data:")
    print(mushData, "\n")

    print("Binary Mushroom Data:")
    binaryData = dt.categoricalToBinary(mushData, colNames, target)
    print(binaryData)
    colNames = list(binaryData)
    target = colNames[-1]
    ...
    for n in nMin:
        ...
        print("\nDoing 10-fold cross-validation for nMin=" + str(n) + "... (please wait... can take a long time)\n")
        accuracyArr, confMatrix = tenFoldCrossValidation(binaryData, colNames, target, n)
        print("\nnMin:", n)
