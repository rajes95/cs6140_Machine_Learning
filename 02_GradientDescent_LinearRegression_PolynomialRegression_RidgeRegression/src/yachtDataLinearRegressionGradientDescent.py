...
2.1 - Gradient Descent for Linear Regression - Yacht Dataset
...
def main():
    '''
    Runs Gradient descent for Yacht dataset to determine linear regression weights
    '''
...
#     pd.set_option('display.max_rows', None)
    ...
    gd.tenFoldCrossValidation(yachtData, target, learningRate, tolerance)
