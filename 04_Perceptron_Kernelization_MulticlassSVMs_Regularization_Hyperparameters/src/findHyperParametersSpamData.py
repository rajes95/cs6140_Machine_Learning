...
Problem 3 - Determining Model Hyper-parameters - Spambase Dataset RBF/Gaussian Kernel
...
#     pd.set_option('display.max_rows', None)
    ...
    cVals = [ 2 ** 1,2 ** 5, 2 ** 10, 2 ** 12]
    gammaVals = [2 ** -15, 2 ** -9, 2 ** -3, 2 ** 1]

    results = nestedCrossValidation(spamData, cVals, gammaVals)
