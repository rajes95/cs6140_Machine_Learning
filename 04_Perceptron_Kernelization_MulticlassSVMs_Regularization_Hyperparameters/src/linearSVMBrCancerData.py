...
Problem 3 - Determining Model Hyper-parameters - Breast Cancer Dataset Linear Kernel
...
#     pd.set_option('display.max_rows', None)
    ...
    colNames = range(31)
    try:
        cancData = pd.read_csv("datasets/breastcancer.csv", names=colNames)
    except:
        print("File not found")

    print(cancData)

    results = kFoldCrossValidation(cancData)
